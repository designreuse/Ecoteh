...
/**
 * Class of basic configurations for the Spring: JpaTransactionManager,
 * LocalContainerEntityManagerFactoryBean, DataSource, HibernateJpaVendorAdapter.
 ...
 * the package "ua.com.ecoteh.repository" and set to interact with
