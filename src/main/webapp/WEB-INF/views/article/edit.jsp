...
<compress:html removeIntertagSpaces="true">
    ...
    <head>
        ...
        <title>Редактирование статьи <c:out value="&quot;${article.title}&quot; | ${main_company.title}"/></title>
        <meta name="title"
              content="Редактирование статьи <c:out value="&quot;${article.title}&quot; | ${main_company.title}"/>">
                                ...
                                <tr>
                                    ...
                                    <td class="tds">
                                        <input type="number" class="form-control" name="price" min="0" step="0.5"
                                               ...
                                               value="<c:out value="${article.sortPrice}"/>">
                                    </td>
                                </tr>
                                <tr>
