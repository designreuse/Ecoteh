            ...
            <div class="row">
                <div class="box">
                    ...
                    <div class="text-center">
                        <form enctype="multipart/form-data" method="post" action="/admin/company/add">
                            <table align="center" class="table-size">
                                ...
                                <tr>
                                    ...
                                    <td class="tds">
                                        <textarea class="form-control textarea" name="advantages" rows="6" title=""
                                                  placeholder="Преимущества над другими компаниями"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="ths">
                                ...
                                <tr>
                                    ...
                                    <td class="tds">
                                        <textarea class="form-control textarea" name="keywords" rows="3" title=""
                                                  required
                                ...
                                <tr>
                                    <th class="ths">
                                        ...
                                        <a rel="lightgallery[maps]" href="/resources/img/static/google_maps_1.jpg"
                                           title="Офис на карте Google Maps. Где это взять?">
                                            <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
                                        </a>
                                        <a href="/resources/img/static/google_maps_2.jpg" rel="lightgallery[maps]"
                                           title="Офис на карте Google Maps."></a>
                                        <a href="/resources/img/static/google_maps_3.jpg" rel="lightgallery[maps]"
                                           title="Офис на карте Google Maps."></a>
                                        <a href="/resources/img/static/google_maps_4.jpg" rel="lightgallery[maps]"
                                           title="Офис на карте Google Maps."></a>
                                    </th>
                                    <td class="tds">
