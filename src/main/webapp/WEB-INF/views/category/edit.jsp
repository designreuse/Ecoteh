...
<compress:html removeIntertagSpaces="true">
    ...
    <head>
        ...
        <title>Редактирование категории <c:out value="&quot;${category.title}&quot; | ${main_company.title}"/></title>
        <meta name="title"
              content="Редактирование категории <c:out value="&quot;${category.title}&quot; | ${main_company.title}"/>">
                            ...
                            <table align="center" class="table-size">
                                ...
                                <tr>
                                    ...
                                    <textarea class="form-control textarea" name="text" rows="10" required
                                              ...
                                              title=""><c:out value="${category.text}"/></textarea>
                                    </td>
                                </tr>
                                <tr>
