                ...
                <div class="box">
                    <c:if test="${authorized_user ne null}">
                        ...
                        <div class="text-center">
                            ...
                            <a href="<c:url value="/admin/section/edit/${section.url}"/>"
                            ...
                            <a href="<c:url value="/admin/section/delete/${section.url}"/>"
                    ...
                    <p class="path">
                        ...
                        → <a href="<c:url value="${reqmap}/section/all"/>" title="Перейти к всем разделам">Все разделы</a>
