...
<compress:html removeIntertagSpaces="true">
    ...
    <head>
        ...
        <title>
            Редактирование поста &quot;<c:out value="${post.title}"/>&quot; | <c:out value="${main_company.title}"/>
        </title>
        <meta name="title"
              content="Редактирование поста &quot;<c:out value="${post.title}"/>&quot; | <c:out value="${main_company.title}"/>">
        <meta name="description"
              content="Форма для редактирования поста &quot;<c:out value="${post.title}"/>&quot;.">
        <meta name="keywords"
              content="Редактирование поста, <c:out value="${post.title}"/>, <c:out value="${post.keywords}"/>"/>
