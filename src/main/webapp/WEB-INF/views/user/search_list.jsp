                        ...
                        <div class="${div_class}">
                            <div class="text-center">
                                ...
                                <c:if test="${not empty contacts.vkontakte}">
                                    <a href="<c:out value="${contacts.vkontakte}"/>" title="Профиль в ВКонтакте"
                                       target="_blank">
                                        <span class="fa fa-vk fa-2x"></span>
                                    </a>&nbsp;&nbsp;
                                </c:if>
                                <c:if test="${not empty contacts.facebook}">
                                    <a href="<c:out value="${contacts.facebook}"/>" title="Профиль в Facebook"
                                       target="_blank">
                                        <span class="fa fa-facebook-official fa-2x"></span>
                                    </a>&nbsp;&nbsp;
                                </c:if>
                                <c:if test="${not empty contacts.twitter}">
                                    <a href="<c:out value="${contacts.twitter}"/>" title="Профиль в Twitter"
                                       target="_blank">
                                ...
                                <c:if test="${authorized_user ne null}">
                                    <div class="pad">
                                        ...
                                        <a href="<c:url value="/admin/user/delete/${user.url}"/>"
                                           ...
                                           onclick="if(confirm('Вы точно хотите удалить пользователя &quot;<c:out
                                                   value="${user.name}"/>&quot;? Удаленные объекты восстановлению не подлежат!')) this.submit; else return false;">
                                            <button class="btn btn-default">
