!function (a, b) {
    ...
    var s = function (a) {
        ...
        function va(a) {
            ...
            }]; f > i; i++)if (c = d.relative[a[i].type])m = [qa(ra(m), c)]; else {
        ...
        var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = "sizzle" + -new Date, v = a.document, w = 0, x = 0, y = fa(), z = fa(), A = fa(), B = function (a, b) {
            return a === b && (l = !0), 0
        ...
        c = ea.support = {}, f = ea.isXML = function (a) {
            ...
            pseudos: {
                not: ga(function (a) {
                    ...
                    return W.test(a || "") || ea.error("unsupported lang: " + a), a = a.replace(ca, da).toLowerCase(), function (b) {
                        var c;
        ...
        return oa.prototype = d.filters = d.pseudos, d.setFilters = new oa, g = ea.tokenize = function (a, b) {
            ...
            if (e = e || [], 1 === o.length) {
                ...
                for (i = X.needsContext.test(a) ? 0 : j.length; i-- && (k = j[i], !d.relative[l = k.type]);)if ((m = d.find[l]) && (f = m(k.matches[0].replace(ca, da), aa.test(j[0].type) && na(b.parentNode) || b))) {
                    if (j.splice(i, 1), a = f.length && pa(j), !a)return I.apply(e, f), e;
                    break
                }
            }
    ...
    m.fn.extend({
        ...
        attr: function (a, b, c) {
            ...
            if (f && 1 === a.nodeType)for (; c = f[e++];)d = m.propFix[c] || c, m.expr.match.bool.test(c) ? rb && qb || !pb.test(c) ? a[d] = !1 : a[m.camelCase("default-" + c)] = a[d] = !1 : m.attr(a, c, ""), a.removeAttribute(qb ? c : d)
        }, attrHooks: {
            type: {
                set: function (a, b) {
    ...
    var Pb = /%20/g, Qb = /\[\]$/, Rb = /\r?\n/g, Sb = /^(?:submit|button|image|reset|file)$/i, Tb = /^(?:input|select|textarea|keygen)/i;
    ...
    var Vb = 0, Wb = {}, Xb = m.ajaxSettings.xhr();
            ...
            return {
                send: function (c, d) {
                    ...
                    f.send(a.hasContent && a.data || null), b = function (c, e) {
                        var h, i, j;
                        if (b && (e || 4 === f.readyState))if (delete Wb[g], b = void 0, f.onreadystatechange = m.noop, e)4 !== f.readyState && f.abort(); else {
