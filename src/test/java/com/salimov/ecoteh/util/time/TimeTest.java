...
import static com.salimov.ecoteh.mocks.MockConstants.TIME;
...
public final class TimeTest {
    ...
    @Test
    public void whenIsWorkTimeWithNullStartHourThenReturnFalse() {
        assertFalse(Time.isWorkTime(null, TIME));
    }
